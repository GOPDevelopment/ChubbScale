Public Class frmEditTare
    ...
    Public Sub StartEditor()
        ...
        'lblProduct.Text = frmKeyboard.ChosenProductCode & "/" & frmKeyboard.ChosenProductDescription
        'ProductCode = frmKeyboard.ChosenProductCode

        'txtBoxTare.Text = frmKeyboard.ChosenTare
        'txtItemCount.Text = frmKeyboard.ChosenItemCountPerBox
        'txtItemTare.Text = frmKeyboard.ChosenItemTareEach
